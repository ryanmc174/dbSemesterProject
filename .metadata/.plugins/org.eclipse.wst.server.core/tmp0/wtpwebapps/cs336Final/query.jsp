...
<body>
	<%
		...
		try {
			...
			String str = "(SELECT * FROM MassShootings_2014 WHERE numKilled >= " + entity + ")"
						+ "UNION "
						+ "(SELECT * FROM MassShootings_2015 WHERE numKilled >= " + entity + ")" 
						+ "UNION "
						+ "(SELECT * FROM MassShootings_2016 WHERE numKilled >= " + entity + ")";
